<xsl:stylesheet  
    ...
    <xsl:template match="*:fields[@function = 'title']">
        <xsl:param name="doc"/>
        <xsl:variable name="field">
            <xsl:value-of select="normalize-space(string-join($doc/descendant-or-self::tei:div[@type='entry']/tei:head,' '))"/>
        </xsl:variable>
        <xsl:if test="$field != ''">
            <string key="{.}" xmlns="http://www.w3.org/2005/xpath-functions">
                <xsl:value-of select="$field"/>
    ...
    <xsl:template match="*:fields[@function = 'idno']">
        <xsl:param name="doc"/>
        <xsl:variable name="field">
            <xsl:value-of select="$doc/descendant::tei:div[@type='entry']/descendant::tei:idno[@type='URI'][1]"/>
        </xsl:variable>
        <xsl:if test="$field != ''">
            <string key="{.}" xmlns="http://www.w3.org/2005/xpath-functions">
                <xsl:value-of select="$field"/>
    ...
    <xsl:template match="*:fields[@function = 'persName']">
        <xsl:param name="doc"/>
        <xsl:param name="id"/>
        <xsl:if test="$doc/descendant::tei:div[@type='entry']/descendant::tei:persName">
                <array key="{.}" xmlns="http://www.w3.org/2005/xpath-functions"> 
                    <xsl:for-each-group select="$doc/descendant::tei:div[@type='entry']/descendant::tei:persName[descendant-or-self::text() != '']" group-by=".">
                        <string xmlns="http://www.w3.org/2005/xpath-functions">
                            <!--<xsl:value-of select="normalize-space(string-join(descendant-or-self::text(),' '))"/>-->
    ...
    <xsl:template match="*:fields[@function = 'placeName']">
        <xsl:param name="doc"/>
        <xsl:param name="id"/>
        <xsl:if test="$doc/descendant::tei:div[@type='entry']/descendant::tei:placeName">
            <array key="{.}" xmlns="http://www.w3.org/2005/xpath-functions"> 
                <xsl:for-each-group select="$doc/descendant::tei:div[@type='entry']/descendant::tei:placeName[descendant-or-self::text() != '']" group-by=".">
                    <string xmlns="http://www.w3.org/2005/xpath-functions">
                        <xsl:apply-templates select="." mode="xmlLang"/>
                    </string>
                </xsl:for-each-group>
    ...
    <xsl:template match="*:fields[@function = 'sources2']">
        <xsl:param name="doc"/>
        <xsl:param name="id"/>
        <xsl:if test="$doc/descendant::tei:div[@type='entry']/descendant-or-self::tei:bibl">
            <array key="{.}" xmlns="http://www.w3.org/2005/xpath-functions"> 
                <xsl:for-each select="$doc/descendant::tei:div[@type='entry']/descendant-or-self::tei:bibl">
                    <string xmlns="http://www.w3.org/2005/xpath-functions">
                        <xsl:apply-templates select="." mode="xmlLang"/>
                    </string>
                </xsl:for-each>
